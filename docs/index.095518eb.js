...
},{}],"VM8Xn":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "7a4a9521095518eb";
"use strict";
...
},{}],"dGyox":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _pineWebp = require("./pine.webp");
var _pineWebpDefault = parcelHelpers.interopDefault(_pineWebp);
var _script = require("../script");
const cr = new _script.Cropo({
    imageUrl: _pineWebpDefault.default,
...
},{"./pine.webp":"9Np0x","../script":"iU8rV","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"9Np0x":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('auX8S') + "pine.417e40cf.webp" + "?" + Date.now();
...
parcelHelpers.export(exports, "Cropo", ()=>Cropo
);
/**
...
/**
 * @deprecated Since version 0.6. Will be deleted in version 1.0. Use Cropo instance instead. (example: new Cropo(config))
 */ parcelHelpers.export(exports, "loadSlider", ()=>loadSlider
);
/**
 ...
 */ parcelHelpers.export(exports, "getCropInfo", ()=>getCropInfo
);
/**
...
class Cropo {
    ...
    constructor(options){
        ...
        if (options?.imageUrl) this.loadImageFromUrl(options?.imageUrl, options?.fit, ()=>{
    ...
    // fix range
    fixScale() {
        if (this.fit) this.scale = Math.min(this.imgWidth / this.canvasWidth, this.imgWidth / this.canvasHeight) || this.baseScale;
        else this.scale = Math.min(this.imgWidth / this.originalWidth, this.imgWidth / this.originalHeight) || this.baseScale;
    ...
    onPointermove(e) {
        ...
        for(let i = 0; i < this.eventCache.length; i++)if (e.pointerId === this.eventCache[i].pointerId) {
            this.eventCache[i] = e;
            break;
        }
        // calc x,y and
    ...
    loadImageFromUrl(url, fitImage = true, onload) {
...
function loadCanvas(...arg) {
    cr.loadCanvas(...arg);
}
function loadImageFromUrl(...arg) {
    cr.loadImageFromUrl(...arg);
}
function loadSlider(...arg) {
    cr.loadSlider(...arg);
}
function move(...arg) {
    cr.move(...arg);
}
function getCropInfo(...arg) {
    cr.getCropInfo(...arg);
}
function getDataUrl(...arg) {
    cr.getDataUrl(...arg);
}
...
},{}]},["emU3S","VM8Xn","dGyox"], "dGyox", "parcelRequire6268")

//# sourceMappingURL=index.095518eb.js.map
